    ...
    <Box style={LoginBox}>
      <Flex>
        ...
        <Box w="50%" h="600px">
         ...
         <Heading fontSize="24px" fontWeight="500" lineHeight="29px">Sign Up</Heading>
        ...
        {/* Age */}
        <Text fontSize="13px" color="#24AEB1" >Age</Text>
        <HStack>
        <InputGroup>
         <Input variant="flushed" pl="10px" type="text" value={user.age}  placeholder="Enter your age..." name="age" onChange={handleChange} />
        </InputGroup>
        </HStack>
        <br/><br/>
        <Button w="100%" backgroundColor="#24AEB1" color="#ffff" onClick={handleSubmit} ><Text>SignUp</Text></Button>
         </Box>
